...
namespace Reqnroll_SpecFlow_Cucumber_Project.Utilities
{
    public static class ExtentReportManager
    {
        ...
        public static void InitReport()
        {
            ...
            {
                string reportDir = @"F:\I-Advance-Github-Projects\AdvanceProject-2\Reqnroll-SpecFlow-Cucumber-Project\TestResults";
                ...
                if (!Directory.Exists(reportDir))
                {
                    ...
                    Console.WriteLine($"Report directory created at: {reportDir}");
                }
