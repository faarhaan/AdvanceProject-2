...
namespace Reqnroll_SpecFlow_Cucumber_Project.Pages.Components.Profile
{
    public class CertificationPage : CommonDriver
    {
        ...
        public readonly By certificationTab = By.XPath("//*[@id=\"account-profile-section\"]/div/section[2]/div/div/div/div[3]/form/div[1]/a[4]");
        ...
        public void InputCertifications(CertificationModel data)
        {
           ...
           // driver.FindElement(certificationTab).Click();  For specFlow i am greying this line as i already used in Give Step so commenting to avoid duplication
