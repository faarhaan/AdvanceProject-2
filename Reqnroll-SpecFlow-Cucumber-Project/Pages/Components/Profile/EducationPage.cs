...
namespace Reqnroll_SpecFlow_Cucumber_Project.Pages.Components.Profile
{
    public class EducationPage : CommonDriver
    {
        ...
        public readonly By educationTab = By.XPath("//*[@id=\"account-profile-section\"]/div/section[2]/div/div/div/div[3]/form/div[1]/a[3]");
        ...
        {
            // Make sure you are on the Education tab
            driver.FindElement(educationTab).Click();
            Thread.Sleep(1000);
            ...
            if (!deleted)
            {
                Assert.Fail($"No matching university found to delete: {data.University}");
            }
            /*
            driver.FindElement(educationTab).Click();
            Thread.Sleep(1000);
